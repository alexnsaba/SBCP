...
//                'email'=>$patient[0]->Email,
            ...
            return redirect('/Predictions')->with('success', 'Prediction Results successfully saved.');
//        return dd($patient[0]->location_id);
        }
        catch(\Exception $e){
            return view('error',['error'=>"Saving prediction results Failed, Hint: No database connection",'error_name'=>"Prediction Error"]);
        }
