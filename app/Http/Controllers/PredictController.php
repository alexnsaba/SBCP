...
class PredictController extends Controller
{
    ...
    public function getPrediction(Request $request){
        ...
        $client = new Client();
        $imageUrl = "/home/arnoldkk/Desktop/FinalYearProject/SBCP/public/images/".$imageName;
        $res = $client->request('POST', "http://127.0.0.1:5000/upload", [
            'multipart' => [
                [
                    ...
                    'name'     => 'image',
                    'contents' => file_get_contents("/home/arnoldkk/Desktop/FinalYearProject/SBCP/public/images/".$imageName),
                ],
            ],
        ]);
