...
<span class="" style="font-size:20pt"><i class="fa fa-stethoscope"></i></span>
<span class="" style="font-size:16pt"> &nbsp; Predictions</span>
</a>
</li>
<li class=" active pcoded-trigger">
<a href="{{url('Visualisations')}}" class="waves-effect waves-dark">
<span class="" style="font-size:20pt"><i class="fa fa-chart-line"></i></span>
<span class="" style="font-size:16pt"> &nbsp;Analysis</span>
</a>
</li>
<li class="pcoded-hasmenu active pcoded-trigger">
<a href="javascript:void(0)" class="waves-effect waves-dark">
<span class="pcoded-micon" style="font-size:20pt"><i class="fa fa-users"></i></span>
<span class="pcoded-mtext" style="font-size:16pt">&nbsp;&nbsp;Manage patient</span>
</a>
<ul class="pcoded-submenu">
<li class="">
<a href="{{url('managepatients')}}" class="waves-effect">
<span class="" style="font-size:16pt"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;Add Patient</span>
 </a>
</li>
<li class="">
<a href="{{url('viewpatient')}}" class="waves-effect waves-dark">
<span class="" style="font-size:16pt"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp;Patient Details</span>
</a>
</li>
</ul>
</li>
