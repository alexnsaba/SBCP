        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form method="POST" class="md-float-material form-material" action="{{ route('login') }}" autocomplete="off">
                        @csrf
...
{{--                                    </div>--}}
                                ...
                                <div class="form-group form-primary">
                                    <input id="username" type="text" name="username" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="off" autofocus>
                                    @error('username')
                                ...
                                <div class="form-group form-primary">
                                    <input id="password" type="password" name="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="off">
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
